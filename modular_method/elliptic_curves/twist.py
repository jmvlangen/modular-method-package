...
def _is_twist_good_char(E1, E2):
    ...
    """
    if E1.c4()**Integer(3)  * E2.c6()**Integer(2)  != E2.c4()**Integer(3)  * E1.c6()**Integer(2) :
        return Integer(0) 
    if E2.c4() == Integer(0) :
        c = E1.c6() / E2.c6()
        try:
            a = c.nth_root(Integer(3) )
            if a.is_square():
                return Integer(1) 
            else:
                return -Integer(1) 
            ...
            return Integer(0) 
    elif E2.c6() == Integer(0) :
        b = E1.c4() / E2.c4()
        try:
            a = b.nth_root(Integer(2) )
            if a.is_square():
                return Integer(1) 
            else:
                return -Integer(1) 
...
def _is_twist_char_2(E1, E2):
    ...
    """
    if (E1.a1() != Integer(0)  or E1.a3() != Integer(0)  or E2.a1() != Integer(0)  or E2.a3() != Integer(0) ):
        return Integer(0) 
    b1 = E1.a2()**Integer(2)  + E1.a4()
    b2 = E2.a2()**Integer(2)  + E2.a4()
    c1 = E1.a2()*E1.a4() + E1.a6()
    c2 = E2.a2()*E2.a4() + E2.a6()
    if b1**Integer(3)  * c2**Integer(2)  != b2**Integer(3)  * c1**Integer(2) :
        return Integer(0) 
    if b2 == Integer(0) :
        c = c1 / c2
        try:
...
def _is_twist_char_3(E1, E2):
    ...
    """
    if (E1.b2()**Integer(2)  * E2.b4() != E2.b2()**Integer(2)  * E1.b4() or
        E1.b2()**Integer(3)  * E2.b6() != E2.b2()**Integer(2)  * E1.b6() or
        E1.b4()**Integer(3)  * E2.b4()**Integer(2)  != E2.b4()**Integer(3)  * E1.b6()**Integer(2) ):
        return Integer(0) 
    if E2.b2() == Integer(0) :
        if E2.b4() == Integer(0) :
            c = E1.b6() / E2.b6()
...
def twist_elliptic_curve(E, d):
    ...
    """
    if E.a1() != Integer(0)  or E.a3() != Integer(0) :
        raise ValueError("Can only twist if a1 and a3 are zero.")
    a2 = d   * E.a2()
    a4 = d**Integer(2)  * E.a4()
    a6 = d**Integer(3)  * E.a6()
    return EllipticCurve([Integer(0) ,a2,Integer(0) ,a4,a6])
